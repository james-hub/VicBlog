...
{
	echo 'Before you run an upgrade it is recomended that you backup your VicBlog database<br><Br>Are you sure you want to upgrade your VicBlog installation from '.$config['version'].' to '.$install_version.'?<br><br><a href="upgrade_1.1.1.php?install=1">Yes do it</a>';
}
else
{
	ignore_user_abort(1);
