...
var BlockFormats = new Array();
  ...
  BlockFormats[2]  = "Definition";
	...
	buttonName[18] = "createlink";
	buttonName[19] = "inserttable";
	buttonName[20] = "insertimage";
	buttonName[21] = "seperator";
	buttonName[22] = "insertflickr";
	buttonName[23] = "insertzooomr";
...
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  ...
  "paste":          ['Paste',                'Paste',              imagesDir + 'paste.gif',              imagesDir + 'paste_on.gif'],
	...
	"insertflickr":     ['InsertFlickr',           'InsertFlickr',         imagesDir + 'flickr2.gif',        imagesDir + 'flickr2_on.gif'],
	"insertzooomr":     ['InsertZooomr',           'InsertZooomr',         imagesDir + 'zooomr.gif',        imagesDir + 'zooomr_on.gif']
};
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
    ...
    if (buttonName[i]) {
      ...
      var buttonImage          = buttonObj[2];
		...
		else if (buttonName[i] == "insertflickr")
		{
		    toolbar += '<td style="width: 38px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button2" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button2\'){className=\'button2Over\'}; this.src=\'' +buttonImageRollover+ '\';" onmouseout="if(className==\'button2Over\'){className=\'button2\'}; this.src=\'' + buttonImage + '\';" unselectable="on" width="34" height="20"></td>';
		}
		else if (buttonName[i] == "insertzooomr")
		{
		    toolbar += '<td style="width: 48px;"><img src="' +buttonImage+ '" border=0 unselectable="on" title="' +buttonTitle+ '" id="' +buttonID+ '" class="button3" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button3\'){className=\'button3Over\'}; this.src=\'' +buttonImageRollover+ '\';" onmouseout="if(className==\'button3Over\'){className=\'button3\'}; this.src=\'' + buttonImage + '\';" unselectable="on" width="46" height="20"></td>';
		}
	    else {
  ...
  + '<iframe frameborder="0" id="wysiwyg' + n + '" onload="draftSaver();"></iframe>\n'
  + '</td></tr></table>\n';
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	var formatIDs = new Array("FontSize","FontName","Bold","Italic","Underline","Subscript","Superscript","Strikethrough","Justifyleft","Justifyright","Justifycenter","InsertUnorderedList","InsertOrderedList","Indent","Outdent","ForeColor","BackColor","InsertImage","InsertTable","CreateLink","InsertFlickr","InsertZooomr");
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=190');
		...
		// InsertFlickr
	  else if (id == "InsertFlickr") {
      window.open('editor_flickr.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=575,height=525');
	  }
	  
	    // InsertZooomr
	  else if (id == "InsertZooomr") {
      window.open('editor_zooomr.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=575,height=525');
	  }
