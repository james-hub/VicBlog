...
<html>
<head>
<title><?php echo $config['site_title'].' '.$lang['ADMIN'].' - '.$lang['EDIT'].' '.$lang['CONTENT']; ?></title>
...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr>
    <td valign="middle" class="heading"><?php echo $lang['EDITCONTENT']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
  </tr>
        ...
        <form action="content_delete.php" method="post" name="f1" id="f1">
          ...
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr bgcolor="#88A2F0">
              ...
              <td width="220" height="30"><span class="rowheader"><?php echo $lang['CONTENT'].' '.$lang['NAME']; ?></span></td>
              <td width="320" height="30"><span class="rowheader"><?php echo $lang['CONTENT'].' '.$lang['TITLE']; ?></span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."content";
...
$query = "SELECT content_id, content_name, content_title FROM `".$config['db']['pre']."content` ORDER BY content_id ASC ".$limit;
...
?>
            ...
            <tr bgcolor="<?php echo $colour; ?>">
              <td width="50" height="25" align="center"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['content_id']; ?>"></td>
              <td height="25"><span class="style5"><?php echo $info['content_name']; ?></span></td>
              <td height="25"><span class="style5"><?php echo $info['content_title']; ?></span></td>
              <td height="25"><table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><select name="amenu<?php echo $info['content_id']; ?>" id="amenu<?php echo $info['content_id']; ?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
                        <option value=""><?php echo $lang['OPTIONS']; ?></option>
                        <option value="content_edit.php?id=<?php echo $info['content_id']; ?>"><?php echo $lang['VIEW']."/".$lang['EDIT'].' '.$lang['CONTENT']; ?></option>
                        <option value="content_delete.php?id=<?php echo $info['content_id']; ?>"><?php echo $lang['DELETE'].' '.$lang['CONTENT'];?></option>
                      </select>
                    </td>
                  </tr>
              </table></td>
...
<?php } ?>
          ...
          <div align="left"> <br>
              <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                  <td width="200" valign="middle"><?php echo $lang['WITHSELECTED']; ?>:&nbsp;<a href="#" onclick="document.f1.action='content_edit.php'; checkBoxes();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
                  <a href="#" onclick="checkBoxes();"><img src="images/button_empty.gif" width="11" height="13" border="0"></a>
