...
<table width="850" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr>
    <td valign="middle" class="heading"><?php echo $lang['EDIT'].' '.$lang['USERS']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
  </tr>
        ...
        <form action="users_delete.php" method="post" name="f1" id="f1">
          ...
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr bgcolor="#344167">
              ...
              <td height="30"><span class="rowheader"><?php echo $lang['USERNAME']; ?></span></td>
              <td width="120" height="30"><span class="rowheader"><?php echo $lang['USERGROUP']; ?></span></td>
              <td width="120" height="30"><span class="rowheader"><?php echo $lang['USER'].' '.$lang['STATUS']; ?></span></td>
...
$query = "SELECT 1 FROM ".$config['db']['pre']."users";
...
$query_result = mysql_query("SELECT user_id, username, usergroup, status FROM ".$config['db']['pre']."users ORDER BY user_id ASC ".$limit."");
...
?>
            <tr bgcolor="<?php echo $colour; ?>">
              <td width="50" height="25" align="center"><input type="checkbox" name="list[]" id="list[]" value="<?php echo $info['user_id']; ?>"></td>
              <td height="25"><span class="style5"><?php echo $info['username']; ?></span></td>
              <td height="25"><span class="style5"><?php echo $user_types[$info['usergroup']]; ?></span></td>
              <td height="25"><span class="style5"><?php echo $user_status[$info['status']]; ?></span></td>
              <td height="25">&nbsp;</td>
            <td height="25">
            <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><select name="amenu<?php echo $info['user_id']; ?>" id="amenu<?php echo $info['user_id']; ?>" onChange="MM_jumpMenu('parent',this,0)" style="width:145px">
                        <option value=""><?php echo $lang['OPTIONS']; ?></option>
                        <option value="users_edit.php?id=<?php echo $info['user_id']; ?>"><?php echo $lang['VIEW']."/".$lang['EDIT'].' '.$lang['USER']; ?></option>
                        <option value="users_delete.php?id=<?php echo $info['user_id']; ?>"><?php echo $lang['DELETE'].' '.$lang['USER']; ?></option>
                      </select>
                    </td>
                  </tr>
              </table>
...
<?php } ?>
          ...
          <div align="left"> <br>
              <table width="99%"  border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                  <td width="200" valign="middle"><?php echo $lang['WITHSELECTED']; ?>:&nbsp;<a href="#" onClick="document.f1.action='users_edit.php'; checkBoxes();"><img src="images/button_edit.gif" width="12" height="13" border="0"></a>
